...
object BroConnStream extends StreamUtils {
 ...
 //   spark.sparkContext.setLogLevel("INFO")
    ...
    val newDF = parsedRawDf  
      ...
      .withColumn("Reconnect", BroConnFeatureExtractionFormula.reconnect(col("orig_pkts").cast(StringType)))
      ...
      .withColumn("label", BroConnLabeling.labeling(col("id.orig_h").cast(StringType)))
